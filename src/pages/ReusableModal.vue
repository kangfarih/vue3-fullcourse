<template>
  <section class="flex flex-wrap w-full">
    <div class="m-auto">
      ...
      <button class="border rounded px-2 mx-4 bg-blue-500 text-white" @click="isModal1Open = true">
        Modal 1
      </button>
      ...
      <button class="border rounded px-2 mx-4 bg-blue-500 text-white" @click="isModal2Open = true">
        Modal 2
      </button>
    </div>
  </section>
